      ...
      <div class="row">
        ...
        <div class="col-md-8 mb-4">
          ...
          <section class="border-bottom mb-4">
            <?php the_post_thumbnail('large-medium', array('class' => 'img-fluid shadow-2-strong rounded-5 mb-4')) ?>
         
              

            <div class="row align-items-center mb-4">
              <div class="col-lg-6 text-center text-lg-start mb-3 m-lg-0">
                  <?php echo get_avatar(get_the_author_meta('ID'), 16, array('class'=>'rounded-5 shadow-1-strong me-2')); ?>
           
                <span> Published <u><?php the_time(); ?></u> by</span>
                <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" class="text-dark"><?php the_author(); ?></a>
              </div>
          ...
          <section class="border-bottom mb-4 pb-4">
            <div class="row">
              <div class="col-3">
            <?php echo get_avatar(get_the_author_meta('ID'), 512, array('class'=>'img-fluid shadow-1-strong rounded-5')); ?>

              </div>

              <div class="col-9">
                <p class="mb-2"><strong><?php the_author(); ?></strong></p>
